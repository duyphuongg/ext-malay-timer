...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const bgColor = await (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getStorage)(_constant__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR);
  const textColor = await (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getStorage)(_constant__WEBPACK_IMPORTED_MODULE_1__.TEXT_COLOR);
  const isShowBottom = await (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getStorage)(_constant__WEBPACK_IMPORTED_MODULE_1__.SHOW_BOTTOM);
  const position = await (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getStorage)(_constant__WEBPACK_IMPORTED_MODULE_1__.POSITION);

  bgColor[_constant__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR]
    ? (eleBackgroundColor.value = bgColor[_constant__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR])
    : (eleBackgroundColor.value = _constant__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR_DEFAULT);
  textColor[_constant__WEBPACK_IMPORTED_MODULE_1__.TEXT_COLOR]
    ? (eleTextColor.value = textColor[_constant__WEBPACK_IMPORTED_MODULE_1__.TEXT_COLOR])
    : (eleTextColor.value = _constant__WEBPACK_IMPORTED_MODULE_1__.TEXT_COLOR_DEFAULT);
  isShowBottom[_constant__WEBPACK_IMPORTED_MODULE_1__.SHOW_BOTTOM] !== undefined
    ? (eleCheckShowBottom.checked = isShowBottom[_constant__WEBPACK_IMPORTED_MODULE_1__.SHOW_BOTTOM])
    : (eleCheckShowBottom.checked = _constant__WEBPACK_IMPORTED_MODULE_1__.SHOW_BOTTOM_DEFAULT);
  position[_constant__WEBPACK_IMPORTED_MODULE_1__.POSITION]
    ? (elePosition.value = position[_constant__WEBPACK_IMPORTED_MODULE_1__.POSITION])
    : (elePosition.value = _constant__WEBPACK_IMPORTED_MODULE_1__.POSITION_DEFAULT);
  ...
  eleBtnApply?.addEventListener("click", (e) => {
    ...
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.setStorage)({ [_constant__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR]: bgColor });
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.setStorage)({ [_constant__WEBPACK_IMPORTED_MODULE_1__.TEXT_COLOR]: textColor });
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.setStorage)({ [_constant__WEBPACK_IMPORTED_MODULE_1__.SHOW_BOTTOM]: isShowBottom });
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.setStorage)({ [_constant__WEBPACK_IMPORTED_MODULE_1__.POSITION]: position });
  });

  eleBtnReset?.addEventListener("click", (e) => {
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.setStorage)({ [_constant__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR]: _constant__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR_DEFAULT });
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.setStorage)({ [_constant__WEBPACK_IMPORTED_MODULE_1__.TEXT_COLOR]: _constant__WEBPACK_IMPORTED_MODULE_1__.TEXT_COLOR_DEFAULT });
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.setStorage)({ [_constant__WEBPACK_IMPORTED_MODULE_1__.SHOW_BOTTOM]: _constant__WEBPACK_IMPORTED_MODULE_1__.SHOW_BOTTOM_DEFAULT });
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.setStorage)({ [_constant__WEBPACK_IMPORTED_MODULE_1__.POSITION]: _constant__WEBPACK_IMPORTED_MODULE_1__.POSITION_DEFAULT });
    eleBackgroundColor.value = _constant__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR_DEFAULT;
    eleTextColor.value = _constant__WEBPACK_IMPORTED_MODULE_1__.TEXT_COLOR_DEFAULT;
    eleCheckShowBottom.checked = _constant__WEBPACK_IMPORTED_MODULE_1__.SHOW_BOTTOM_DEFAULT;
    elePosition.value = _constant__WEBPACK_IMPORTED_MODULE_1__.POSITION_DEFAULT;
  ...
  (0,_helper__WEBPACK_IMPORTED_MODULE_0__.run)(elePreview ?? null);
});
